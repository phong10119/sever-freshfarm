...
Revision ID: 5c13670e7dac
Revises: 
Create Date: 2019-12-04 18:51:22.721315
...
def upgrade():
    ...
    op.create_table('order_status_ids',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['Order_status_id'], ['order_status_ids.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.PrimaryKeyConstraint('product_id', 'rating_id')
    )
...
def downgrade():
    ...
    op.drop_table('order_status_ids')
